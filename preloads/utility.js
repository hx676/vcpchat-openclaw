...
const ALLOWED_KEYS = [
    ...
    "creditGetCase",
    "creditUpdateCase",
    "creditSelectMaterials",
    "creditExtractMaterial",
    "creditUpdateMaterialType",
    "creditSaveExtract",
    "creditSaveExternalData",
    "creditUpdateFieldEvidence",
    "creditGetAssistantChat",
    "creditAppendAssistantChat",
    "creditSendAssistantMessage",
    "creditImportExternalJson",
    "creditRunRules",
    "creditGenerateReport",
    "creditSaveReport",
    "creditExportReport",
    "creditOpenDataFolder",
    "gatewayGetStatus",
    "gatewayStartCcproxy",
    "gatewayRestartCcproxy",
    "gatewayStopCcproxy",
    "gatewaySaveActiveAccount",
    "gatewaySwitchAccount",
    "gatewaySwitchLatestAccount",
    "gatewayDeleteAccount",
    "gatewayLaunchLogin",
    "gatewayOpen",
    "gatewayTestVcp",
    "gatewayTestAccount",
    "gatewayTestAllAccounts",
    "getThemes",
    "applyTheme",
    "executePythonCode",
    "readNotesTree",
