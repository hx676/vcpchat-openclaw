...
If fso.FileExists(launchLogPath & ".prev") Then
    On Error Resume Next
    fso.DeleteFile launchLogPath & ".prev", True
    On Error GoTo 0
End If

If fso.FileExists(launchLogPath) Then
    On Error Resume Next
    fso.MoveFile launchLogPath, launchLogPath & ".prev"
    On Error GoTo 0
End If
