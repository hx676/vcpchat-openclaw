...
function createCatalog(ops) {
    return {
        ...
        openSilverCompanionWindow: command((payload) => ops.send('open-silver-companion-window', payload)),
        openCreditWindow: command(() => ops.send('open-credit-window')),
        openGatewayWindow: command(() => ops.send('open-gateway-window')),
        ...
        getChannelMirrorSessions: query(() => ops.invoke('get-channel-mirror-sessions')),
        getChannelMirrorTopics: query((sessionId) => ops.invoke('get-channel-mirror-topics', sessionId)),
        getChannelMirrorHistory: query((sessionId, topicId) => ops.invoke('get-channel-mirror-history', sessionId, topicId)),
        ...
        createSilverCompanionGroup: query((payload) => ops.invoke('create-silver-companion-group', payload)),
        ...
        onOpenSilverCompanionOpsGroup: subscription(ops.subscribe('silver-companion:open-ops-group', (_event, data) => data)),
        onSilverCompanionOpsGroupHistoryUpdated: subscription(ops.subscribe('silver-companion:ops-group-history-updated', (_event, data) => data)),
...
const ALLOWED_KEYS = [
    ...
    "getChatHistory",
    "saveChatHistory",
    "getChannelMirrorSessions",
    "getChannelMirrorTopics",
    "getChannelMirrorHistory",
    ...
    "onOpenSilverCompanionOpsGroup",
    "onSilverCompanionOpsGroupHistoryUpdated",
    "saveGroupTopicOrder",
